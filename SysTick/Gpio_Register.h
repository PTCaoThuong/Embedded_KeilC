...
/* GPIO_A */
typedef struct{
	volatile unsigned int PDOR_A;
	unsigned int dummy5[3];
	volatile const unsigned int PDIR_A;
	volatile unsigned int PDDR_A;
}GPIOA_Type;
#define GPIOA_BASE_ADDRESS (0x400FF000)
#define GPIO_A ((GPIOA_Type*)GPIOA_BASE_ADDRESS)
...
#define PCR_A_BASE_ADDRESS (0x40049000)
#define PCR_A ((PCR_A_Type*)PCR_A_BASE_ADDRESS)
